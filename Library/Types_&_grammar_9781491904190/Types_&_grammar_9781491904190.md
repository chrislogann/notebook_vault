...
7. Chapter 4: Coercion
   ...
   4. Implicit Coercion
      ...
      5. Operators `||` and `&&`
      6. Symbol Coercion
   5. Loose Equals vs. Strict Equals
...
David Walsh  
 <http://davidwalsh.name>, [@davidwalshblog](http://twitter.com/davidwalshblog)  
...
**Note:** Unfortunately, the JS spec doesn’t really have its operator precedence list in a convenient, single location. You have to parse through and understand all the grammar rules. So we’ll try to lay out the more common and useful bits here in a more convenient format. For a complete list of operator precedence, see “Operator Precedence” on the MDN site (\* https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Operator\_Precedence).
