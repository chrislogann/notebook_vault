---
tags: "Book"
Genre: "[[Async & performance]]"
author: "[[Simpson, Kyle (JavaScript systems architect)]]"
isbn: 9781491904220
---
...
2. Preface
   1. Mission
   2. Summary
3. Chapter 1: Asynchrony: Now & Later
...
6. Chapter 4: Generators
   ...
   9. Review
7. Chapter 5: Program Performance
   1. Web Workers
   ...
   3. asm.js
      ...
      2. asm.js Modules
   4. Review
8. Chapter 6: Benchmarking & Tuning
   1. Benchmarking
      1. Repetition
      2. Benchmark.js
   2. Context Is King
   ...
   7. Review
9. Appendix A: *asynquence* Library
   1. Sequences, Abstraction Design
   2. *asynquence* API
      1. Steps
      2. Errors
      3. Parallel Steps
   ...
   7. Review
10. Appendix B: Advanced Async Patterns
...
**Note:** There’s an official “prollyfill” (hopeful, expectant, future-leaning polyfill) for the SIMD functionality available (https://github.com/johnmccutchan/ecmascript\_simd), which illustrates a lot more of the planned SIMD capability than we’ve illustrated in this section.
...
(http://web.archive.org/web/20130731202547/http://pplab.snu.ac.kr/courses/adv\_pl05/papers/p261-knuth.pdf, Computing Surveys, Vol 6, No 4, December 1974)
