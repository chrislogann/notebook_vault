...
3. Chapter 1: `this` Or That?
   ...
   3. What’s `this`?
   4. Review (TL;DR)
4. Chapter 2: `this` All Makes Sense Now!
   1. Call-site
   2. Nothing But Rules
      1. Default Binding
      2. Implicit Binding
...
5. Chapter 3: Objects
   ...
   4. Iteration
   5. Review (TL;DR)
6. Chapter 4: Mixing (Up) “Class” Objects
   1. Class Theory
   ...
   4. Mixins
      ...
      2. Implicit Mixins
   5. Review (TL;DR)
7. Chapter 5: Prototypes
   1. `[[Prototype]]`
      1. `Object.prototype`
      2. Setting & Shadowing Properties
   2. “Class”
      1. “Class” Functions
      2. “Constructors”
      3. Mechanics
   ...
   5. Review (TL;DR)
8. Chapter 6: Behavior Delegation
