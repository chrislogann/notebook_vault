---
tags: Book
Genre: "[[You Don't Know JS Yet: Get Started]]"
author:
  - "[[Simon St.Laurent]]"
  - "[[Brian Holt]]"
  - "[[Simpson, Kyle (JavaScript systems architect)]]"
isbn: 9798602477429
---
...
3. Chapter 1: What *Is* JavaScript?
   ...
   3. Language Specification
      1. The Web Rules Everything About (JS)
      2. Not All (Web) JS…
      3. It’s Not Always JS
   4. Many Faces
   ...
   8. Defined
4. Chapter 2: Surveying JS
   1. Each File is a Program
   2. Values
      1. Arrays And Objects
      2. Value Type Determination
...
5. Chapter 3: Digging to the Roots of JS
   1. Iteration
      1. Consuming Iterators
      2. Iterables
   2. Closure
   3. `this` Keyword
   4. Prototypes
      ...
      2. `this` Revisited
   5. Asking “Why?”
6. Chapter 4: The Bigger Picture
   1. Pillar 1: Scope and Closure
   2. Pillar 2: Prototypes
   3. Pillar 3: Types and Coercion
   4. With the Grain
   5. In Order
7. Appendix A: Exploring Further
   1. Values vs. References
   2. So Many Function Forms
   3. Coercive Conditional Comparison
   4. Prototypal “Classes”
8. Appendix B: Practice, Practice, Practice!
   1. Practicing Comparisons
   2. Practicing Closure
   3. Practicing Prototypes
...
![Interpreting a script to execute it](images/file0.svg)
...
![Parsing, compiling, and executing a program](images/file1.svg)
...
![Steps of JS compilation and execution](images/file2.svg)
...
1. ECMAScript 2019 Language Specification, Appendix B: Additional ECMAScript Features for Web Browsers, https://www.ecma-international.org/ecma-262/10.0/#sec-additional-ecmascript-features-for-web-browsers (latest as of time of this writing in January 2020)[↩︎](#fnref1)
...
![Prototype chain with 3 objects](images/file3.svg)
...
![3 objects linked, with shadowed property](images/file4.svg)
...
![4 objects prototype linked](images/file5.svg)
