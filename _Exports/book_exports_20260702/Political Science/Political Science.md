...
- **The Political Lifecycle:** This is defined as the predictable "gravity of power" where visionary political movements cycle through distinct phases. It begins with "grassroots purity", transitions to a "realist inversion" where the movement is captured by the predatory logic of the state, moves to the weaponization and abstraction of its original ideals, and ultimately descends into administrative collapse, vigilantism, or informal control mechanisms like "telephone law" (_pozvonochnost’_).
- **Politics and War:** Politics is practically characterized through its relationship with force, specifically as an activity that can be extended "by military means" during times of crisis